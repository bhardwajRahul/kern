...
- Published 0.2.0 through 0.2.15 on PyPI and npm. **0.2.0 was a MINOR bump because `fault.type`
...
- 1325 Rust, 504 Python and 109 Node tests, and the count is gated against the README.
