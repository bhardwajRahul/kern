...
| [kern-mcp setup](../bindings/python/README.md#use-it-from-an-mcp-client-cursor-claude-desktop-anything-that-speaks-mcp) | Wire **`kern-mcp`** into Claude Desktop / Cursor / Windsurf: a local, **network-off** code interpreter, with every knob in one table |
