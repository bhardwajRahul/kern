...
| [kern-mcp setup](../bindings/python/README.md#use-it-from-claude-desktop-or-cursor-mcp) | Wire **`kern-mcp`** into Claude Desktop / Cursor / Windsurf: a local, **network-off** code interpreter, with every knob in one table |
